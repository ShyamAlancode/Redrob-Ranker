...
- Why MiniLM? (CPU budget; quality is dominated by structural rules anyway)
...
- Why is education ignored? (the JD never mentions it; adding unrequested
  features is how you overfit to your own assumptions)
- Why is the embedding matrix not in git? (147 MB > GitHub's 100 MB limit;
